					...
					<div class="row">
						<div class="col-md-5">
							<ul class="prod-slider">
                                ...
                                foreach ($result as $row) {
                                    ?>
                                    <li style="background-image: url(assets/uploads/Apple_product/<?php echo $row['photo']; ?>);">
                                        <a class="popup" href="assets/uploads/Apple_product/<?php echo $row['photo']; ?>"></a>
                                    </li>
                                    <?php
                                }
                                ?>
							...
							<div id="prod-pager">
                                ...
                                foreach ($result as $row) {
                                    ?>
                                    <a data-slide-index="<?php echo $i; ?>" href=""><div class="prod-pager-thumb" style="background-image: url(assets/uploads/Apple_product/<?php echo $row['photo']; ?>"></div></a>
                                    <?php
                                    $i++;
                                }
                                ?>
